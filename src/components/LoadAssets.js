...
var NAVIGATION_STATE_KEY = "NAVIGATION_STATE_KEY";
...
var useLoadAssets = function (assets, fonts) {
    ...
    usePromiseAll(__spreadArray([Font.loadAsync(fonts)], assets.map(function (asset) { return expo_asset_1.Asset.loadAsync(asset); })), function () { return setReady(true); });
    return ready;
};
var LoadAssets = function (_a) {
        ...
        var restoreState = function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, , 2, 3]);
                        return [4 /*yield*/, async_storage_1["default"].getItem(NAVIGATION_STATE_KEY)];
                    case 1:
    ...
    var onStateChange = react_1.useCallback(function (state) {
        return async_storage_1["default"].setItem(NAVIGATION_STATE_KEY, JSON.stringify(state));
    }, []);
